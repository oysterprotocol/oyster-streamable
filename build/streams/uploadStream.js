...
var UploadStream = (function(_Writable) {
  ...
  function UploadStream(
    ...
    var _this = _possibleConstructorReturn(
      this,
      (UploadStream.__proto__ || Object.getPrototypeOf(UploadStream)).call(
        this,
        opts
      )
    );
    ...
    _this.retries = 0;
    _this.progressCb = opts.progressCb || console.log;
  ...
  _createClass(UploadStream, [
    ...
    },
    {
      ...
      value: function _upload(batch) {
        ...
        if (batch.order === CHUNK_ORDER_ASC) {
          upload = (0, _backend.sendToBroker)(
            this.alpha,
            this.sessIdA,
            batch.chunks
          );
        ...
        upload
          .then(function(result) {
            _this2._afterUpload(batch.chunks.length);
          })
    ...
    {
      key: "_afterUpload",
      value: function _afterUpload(batchSize) {
        var _this3 = this;
        ...
        console.log(
          "upload progress: " + this.chunksProcessed + " / " + this.numChunks
        );
        // Emit progress
        var prog =
          (0, _math.clamp)(this.chunksProcessed / this.numChunks, 0, 1) * 100;
